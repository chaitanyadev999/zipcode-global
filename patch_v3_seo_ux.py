...
if __name__ == '__main__':
    ...
    for file_path in files:
        ...
        try:
            ...
            # If it already has the <details> wrapper, skip it
            ...
            city_path = path_parts[3].replace('.html', '') if len(path_parts) == 4 else ''
            
            # For state pages, CITY is the state name.
            path_url = file_path.replace('\\', '/')
            ...
            # Get the full country name for the schema
    ...
    print(f"DONE! Total Patched: {count}, Skipped: {skipped}", flush=True)
